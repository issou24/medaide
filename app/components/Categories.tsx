    ...
    <div className="pt-3 cursor-pointer pb-6 flex items-center space-x-12">
      <div className="pb-4 flex-col items-center space-y-2 border-b-2 opacity-60 hover:border-gray-200 hover:opacity-100">
        <Image
          ...
          alt="Médecine Générale"
          width={20}
          height={20}
        />

        <span className="text-xs">Médecine Générale</span>
      </div>

      <div className="pb-4 flex-col items-center space-y-2 border-b-2 opacity-60 hover:border-gray-200 hover:opacity-100">
        <Image src="/pediatrie.png" alt="Pédiatrie" width={20} height={20} />
      ...
      <div className="pb-4 flex-col items-center space-y-2 border-b-2 opacity-60 hover:border-gray-200 hover:opacity-100">
        <Image
          src="/gynécologie-obstétrique.png"
